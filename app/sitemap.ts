...
const STATIC_PAGES: StaticPage[] = [
  ...
  { path: "/elektroinstalace", priority: 0.6, changeFrequency: "monthly" },
  { path: "/koupelna", priority: 0.6, changeFrequency: "monthly" },
  { path: "/zdarma", priority: 0.6, changeFrequency: "monthly" },
