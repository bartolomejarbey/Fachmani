...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { name: "Recenze zákazníků", href: "/admin/recenze-zakazniku", icon: "💜", roles: ["master_admin", "admin"] },
        ...
        <header className="bg-slate-800/30 border-b border-white/5 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              {/* Notifications */}
              <button aria-label="Notifikace" className="relative p-2 text-slate-400 hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
