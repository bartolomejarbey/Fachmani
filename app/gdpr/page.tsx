  ...
  const sections = [
    {
      ...
      icon: "🏢",
      content: `Správcem osobních údajů je společnost Harotas s.r.o., IČO: 21402027, se sídlem Běleč 30, 391 43 Běleč (dále jen „Správce").

Kontakt pro záležitosti ochrany osobních údajů: bartolomej@arbey.cz`
    },
    {
      id: "udaje",
...
Pro uplatnění svých práv nás kontaktujte na bartolomej@arbey.cz.`
    },
    {
      id: "cookies",
      title: "8. Cookies",
...
Adresa: Harotas s.r.o., Běleč 30, 391 43 Běleč
