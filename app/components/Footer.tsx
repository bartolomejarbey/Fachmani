        ...
        <div className="max-w-7xl mx-auto px-6 pt-16 pb-12">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-5">
              ...
              {/* Přímý kontakt — telefon + e-mail. tel: / mailto: na mobilu spustí dial/mail app. */}
              <div className="mt-8 space-y-3">
                <a
                  href={`tel:${OPERATOR.phone.replace(/\s+/g, "")}`}
                  className="group flex items-center gap-3 text-gray-300 transition hover:text-cyan-400"
                >
                  <span className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-white/5 ring-1 ring-white/10 transition group-hover:bg-cyan-500/10 group-hover:ring-cyan-400/40">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
                      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.37 1.9.72 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.35 1.85.59 2.81.72A2 2 0 0 1 22 16.92z" />
                    </svg>
                  </span>
                  <span className="font-semibold tracking-wide">{OPERATOR.phone}</span>
                </a>
                <a
