...
Aktuální ceník je dostupný na stránce Ceník. Provozovatel si vyhrazuje právo změnit ceník s předchozím oznámením.`
    ...
    {
      id: "overeni",
      title: "5. Verifikace profilu",
      content: `Platforma může v budoucnu nabídnout verifikaci profilu poskytovatelů služeb. Tato funkce je v současnosti ve vývoji a nemusí být dostupná.

Podmínky případné verifikace budou zveřejněny samostatně po jejím spuštění.`
    },
    {
      id: "odpoved",
      title: "6. Odpovědnost",
