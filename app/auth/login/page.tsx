  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute top-20 left-10 w-72 h-72 bg-cyan-200/30 rounded-full opacity-30 animate-float"></div>
        <div className="absolute bottom-10 right-10 w-96 h-96 bg-blue-200/30 rounded-full opacity-30 animate-float animation-delay-200"></div>
