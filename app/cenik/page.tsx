  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="absolute top-20 right-0 w-96 h-96 bg-cyan-100/50 rounded-full opacity-30"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-blue-100/50 rounded-full opacity-30"></div>
